...
//	@GetMapping("/countCouponInspection")
//	public SseEmitter countCouponInspection() {
//		SseEmitter emitter = new SseEmitter();
//		SseEventBuilder eventBuilder = SseEmitter.event();
//
//		nonBlockingService.execute(() -> {
//			try {
////couponInspectionsMongoService.countCouponInspection()
//				emitter.send(eventBuilder.data(" " + objectMapper.writeValueAsString(1) + "\n\n")
//						.name("dataSet-created").id("123456").reconnectTime(3000)
//
//				);
//
//				emitter.complete();
