		...
		<div class="container mb-5">
			<div class="page-content page-wdth-main">
				<div class="text-center">
					...
					<!--  Main Matrix Data -->
					<h6 class="mb-1" style="font-size: 25px">COUPON PRINTING EVENT</h6>
			</div>
			<div class="table-responsive">
				...
				<table class="table bottle-info table-bordered bg-white mx-auto" style="width: 80%;font-size: 18px">
					...
					<tr>
						<td bgcolor="orange" ><strong>Coupon Size:</strong> <span class="data-value"
		...
		$(document)
				.ready(
						function() {
							...
							var sse = new EventSource('/couponprinting/sse');
